...
const AdminAnalytics = () => {
    ...
    const fetchAdminAnalytics = async () => {
        try {
            const response = await axios.get(`${backendUrl}/api/admin/admin-analytics`, {
    ...
    const fetchPieChartAnalytics = async () => {
        try {
            const response = await axios.get(`${backendUrl}/api/admin/admin-pie-chart-analytics`, {
                headers: { Authorization: `Bearer ${token}` }
            });

            if (response?.data?.success) {
                console.log("✅ Pie Chart Data:", response.data.pieChartData);
                const { totalLeads, totalLostLeads, totalInterestedLeads, totalLeadsInPipeline, totalOpenLeads } = response?.data?.pieChartData;
                    ...
                    datasets: [
                        {
                            ...
                            data: [totalLeads, totalLostLeads, totalInterestedLeads, totalLeadsInPipeline, totalOpenLeads],
    ...
    const fetchLeadLostReasonDoughnut = async () => {
        try {
            const response = await axios.get(`${backendUrl}/api/admin/lead-lost-reason-doughnut`, {
                headers: { Authorization: `Bearer ${token}` },
            });
                        ...
                        <div className='row'>
                            ...
                            <div className='col-lg-3'>
                                <div className='dashboard_card'>
                                    ...
                                    <p className='number_text'>{dashboardOne.totalNotInterestedLeads || 0}</p>
                                </div>
                            </div>
                            ...
                            <div className='col-lg-3'>
                                <div className='dashboard_card'>
                                    ...
                                    <p className='number_text'>{dashboardOne.totalInterestedLeads || 0}</p>
                                </div>
                            </div>
                            ...
                            <div className='col-lg-3'>
                                <div className='dashboard_card'>
                                    ...
                                    <p className='number_text'>{dashboardOne.totalDraftLeads || 0}</p>
                                </div>
                            </div>
                            ...
                            <div className='col-lg-3'>
                                <div className='dashboard_card'>
                                    ...
                                    <p className='number_text'>{dashboardOne.totalOpenLeads || 0}</p>
                                </div>
                            </div>
                            ...
                            <div className='col-lg-3'>
                                <div className='dashboard_card'>
                                    ...
                                    <p className='number_text'>{dashboardOne.totalClosedLeads || 0}</p>
                                </div>
                            </div>
                            ...
                            <div className='col-lg-3'>
                                <div className='dashboard_card'>
                                    ...
                                    <p className='number_text'>{dashboardOne.totalLostLeads || 0}</p>
                                </div>
                            </div>
                            ...
                            <div className='col-lg-3'>
                                <div className='dashboard_card'>
                                    ...
                                    <p className='number_text'>{dashboardOne.totalLeadsInPipeline || 0}</p>
                                </div>
                            </div>
