  ...
  const handleFilterChange = (filterData) => {
    ...
    if (filterData.type === "date") {
      ...
      filtered = leads.filter(
        (lead) => format(new Date(lead.assignedDate), "yyyy-MM-dd") === filterData.value
      );
      ...
      filtered = leads.filter((lead) => {
        const assignedDate = new Date(lead.assignedDate);
        return assignedDate >= new Date(filterData.value.start) && assignedDate <= new Date(filterData.value.end);
      });
    }
